...
.form-control {
    ...
    -webkit - box - shadow ease - in -out .15 s; -
    o - transition: border - color ease - in -out .15 s,
    box - shadow ease - in -out .15 s;
    transition: border - color ease - in -out .15 s,
    box - shadow ease - in -out .15 s
}
.form - control: focus {
        border - color: #66afe9;
...
.has-success .form-control {
    ...
    .has - success.form - control: focus {
        border - color: #2b542c;
    -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 6px # 67 b168;
        box - shadow: inset 0 1 px 1 px rgba(0, 0, 0, .075), 0 0 6 px #67b168
}
...
tbody.collapse.in {
    ...
    .collapsing {
        ...
        webkit - transition - duration: .35 s; -
        o - transition - duration: .35 s;
    ...
    .dropdown - menu {
        ...
        border - radius: 4 px; -
        webkit - box - shadow: 0 6 px 12 px rgba(0, 0, 0, .175);
...
@media(min - width: 768 px) {
    ...
    .navbar - collapse {
        ...
        webkit - box - shadow: inset 0 1 px 0 rgba(255, 255, 255, .1);
...
@media screen and(min - width: 768 px) {
    ...
    .thumbnail {
        ...
        border: 1 px solid# ddd;
        border - radius: 4 px; -
        webkit - transition: border .2 s ease - in -out; -
        o - transition: border .2 s ease - in -out;
...
.progress {
    ...
    background-color: # f5f5f5;
        border - radius: 4 px; -
        webkit - box - shadow: inset 0 1 px 2 px rgba(0, 0, 0, .1);
        box - shadow: inset 0 1 px 2 px rgba(0, 0, 0, .1)
    }
    .progress - bar {
        float: left;
        width: 0;
...
a.list - group - item - danger.active,
    ...
    .panel {
        ...
        border: 1 px solid transparent;
        border - radius: 4 px; -
        webkit - box - shadow: 0 1 px 1 px rgba(0, 0, 0, .05);
...
.panel-warning>.panel-footer+.panel-collapse>.panel-body {
    ...
    .well {
        ...
        border - radius: 4 px; -
        webkit - box - shadow: inset 0 1 px 1 px rgba(0, 0, 0, .05);
...
.popover {
    ...
    background-color: # fff; -
        ...
        border - radius: 6 px; -
        webkit - box - shadow: 0 5 px 10 px rgba(0, 0, 0, .2);
...
.popover.left>.arrow:after {
    ...
    .carousel - inner > .item {
        position: relative;
        display: none; -
        webkit - transition: .6 s ease - in -out left; -
        o - transition: .6 s ease - in -out left;
...
@media all and(transform - 3 d),
    (-webkit - transform - 3 d) {
        .carousel - inner > .item {
                -webkit - transition: -webkit - transform .6 s ease - in -out; -
                o - transition: -o - transform .6 s ease - in -out;
                transition: transform .6 s ease - in -out; -
    ...
    .carousel - control {
        ...
        color: #fff;
        text - align: center;
        text - shadow: 0 1 px 2 px rgba(0, 0, 0, .6);
